...
add_action('init', function () {
    ...
    add_image_size('banner', 1920, 1440, true);
    add_image_size('banner-mobile', 800, 900, true);
    add_image_size('image-header', 1920, 1440, true);
    add_image_size('image-header-mobile', 800, 900, true);
});
